...
class DataFrameSuite extends QueryTest
  ...
  test("SPARK-XXXXX: build the stats for LogicalRDD based on origin stats") {
  ...
  test("SPARK-XXXXX: build the constraints for LogicalRDD based on origin constraints") {
