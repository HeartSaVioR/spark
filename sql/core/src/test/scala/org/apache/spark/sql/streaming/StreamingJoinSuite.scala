  ...
  test("...DEBUG...") {
    withSQLConf(
      ...
      testStream(joined)(
        ...
        // watermark: 2020-01-02 00:00:00
        CheckNewAnswer(),
        AddData(input1, (Timestamp.valueOf("2020-01-02 01:30:00"), "abc", "left in batch 3")),
        // watermark: 2020-01-02 01:00:00
        // data loss happens, specifically in rocksdb state store
        CheckNewAnswer(
